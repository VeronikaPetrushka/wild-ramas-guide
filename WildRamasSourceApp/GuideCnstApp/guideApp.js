const guideApp = [
    ...
    {
        guideScreen: 'WildJournalScreenGuide',
        wildImage: require('../WildRamasAssetsApp/guideNavigation/journal.png'),
        wildName: 'Journal'
    },
    {
        guideScreen: 'RamasGuizScreenGuide',
        wildImage: require('../WildRamasAssetsApp/guideNavigation/quiz.png'),
        wildName: 'Quiz'
    },
    {
